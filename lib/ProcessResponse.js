  ...
  constructor(){
    this.responses = {"welcomeSuccessful": "<speak>Welcome to Question Time! Which of these is the largest? A. a tennis ball, B. a bowling ball, C. a house, or D. the sun</speak>",
     ...
     "answerSuccessful": "<speak>That's right! Thanks for playing.</speak>",
      ...
      "answerUnsuccessfulNoQuestion": "<speak>Sorry, I don't know what question you're answering!.</speak>"
    }
  }
  /**
  ...
  returnResponse(type){
    switch(type){
      ...
      case "answerIncorrect":
        ...
        break;
      case "answerUnsuccessful-no-question":
        return this.generateResponse(this.responses.answerUnsuccessfulNoQuestion);

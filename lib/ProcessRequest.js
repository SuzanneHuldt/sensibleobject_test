...
*/
  ...
  processIntent(request, questionCounter, answerCounter){
    console.log(this.isValid(request, answerCounter))
    this.isValid(request, answerCounter);
    return this.hasReceivedQuestion(request, questionCounter, answerCounter);
  }
